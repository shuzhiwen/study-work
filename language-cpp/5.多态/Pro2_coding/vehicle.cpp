...
void Vehicle::setColor(string color) { vehicleColor = color; }  // end function setColor
...
// return class name
string Vehicle::getClassName() const { return "Vehicle"; }  // end function getClassName

void Vehicle::horn() const { cout << "di di di"; }
