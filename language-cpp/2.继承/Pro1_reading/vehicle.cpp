...
// constructor
Vehicle::Vehicle(const int doors, const int cylinders, string color, double initialFuel,
...
void Vehicle::setColor(string colour) { vehicleColor = colour; }
...
// return color
string Vehicle::getColor() const { return vehicleColor; }  // end function getColor

// return fuelLevel
double Vehicle::getFuelLevel() const { return fuelLevel; }  // end function getFuelLevel
...
int Vehicle::getNumberOfDoors() const { return numberOfDoors; }  // end function getNumberOfDoors
...
void Vehicle::setClassName(string newName) { className = newName; }  // end function setClassName

// return className
string Vehicle::getClassName() const { return className; }  // end function getClassName
