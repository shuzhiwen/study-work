...
static PyObject *__pyx_pf_4fib3_fibtime(CYTHON_UNUSED PyObject *__pyx_self,
                                        int __pyx_v_n); /* proto */
...
static PyMethodDef __pyx_mdef_4fib3_1fibtime = {"fibtime", (PyCFunction)__pyx_pw_4fib3_1fibtime,
                                                METH_O, 0};
static PyObject *__pyx_pw_4fib3_1fibtime(PyObject *__pyx_self, PyObject *__pyx_arg_n) {
    ...
    assert(__pyx_arg_n);
    {
        __pyx_v_n = __Pyx_PyInt_As_int(__pyx_arg_n);
        if (unlikely((__pyx_v_n == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 8, __pyx_L3_error)
    }
...
static PyObject *__pyx_pf_4fib3_fibtime(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_n) {
     ...
     *   print(time.time() - t)
     */
    __pyx_t_1 = __Pyx_PyInt_From_PY_LONG_LONG(__pyx_f_4fib3_fib(__pyx_v_n));
    ...
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_time);
    ...
    __Pyx_DECREF(__pyx_t_2);
    __pyx_t_2 = 0;
    __pyx_t_2 = PyNumber_Subtract(__pyx_t_1, __pyx_v_t);
    if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 11, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_1);
    __pyx_t_1 = 0;
...
static int __Pyx_InitCachedConstants(void) {
     ...
     *   print(fib(n))
     */
    __pyx_tuple_ = PyTuple_Pack(3, __pyx_n_s_n, __pyx_n_s_n, __pyx_n_s_t);
    if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 8, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_tuple_);
    __Pyx_GIVEREF(__pyx_tuple_);
    __pyx_codeobj__2 = (PyObject *)__Pyx_PyCode_New(
        1, 0, 3, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple_,
        __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_fib3_pyx, __pyx_n_s_fibtime, 8,
        __pyx_empty_bytes);
    if (unlikely(!__pyx_codeobj__2)) __PYX_ERR(0, 8, __pyx_L1_error)
    __Pyx_RefNannyFinishContext();
    return 0;
__pyx_L1_error:;
    __Pyx_RefNannyFinishContext();
...
/*--- Module creation code ---*/
#if PY_MAJOR_VERSION < 3
    __pyx_m = Py_InitModule4("fib3", __pyx_methods, 0, 0, PYTHON_API_VERSION);
    Py_XINCREF(__pyx_m);
#else
...
#if PY_MAJOR_VERSION >= 3
    {
        ...
        if (!PyDict_GetItemString(modules, "fib3")) {
            if (unlikely(PyDict_SetItemString(modules, "fib3", __pyx_m) < 0))
                __PYX_ERR(0, 1, __pyx_L1_error)
        }
    }
#endif
...
/*--- Execution code ---*/
     ...
     *   print(fib(n))
     */
    __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_4fib3_1fibtime, NULL, __pyx_n_s_fib3);
...
static CYTHON_INLINE PyObject *__Pyx_PyInt_From_PY_LONG_LONG(PY_LONG_LONG value) {
    ...
    }
    {
        ...
        return _PyLong_FromByteArray(bytes, sizeof(PY_LONG_LONG), little, !is_unsigned);
    }
}
